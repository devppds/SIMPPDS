...
const headersConfig = {
    'santri': ["stambuk_pondok", "stambuk_madrasah", "tahun_masuk", "kamar", "status_mb", "madrasah", "kelas", "nik", "nama_siswa", "nisn", "tempat_lahir", "tanggal_lahir", "tempat_tanggal_lahir", "jenis_kelamin", "agama", "kewarganegaraan", "anak_ke", "jumlah_saudara", "tinggi_badan", "berat_badan", "golongan_darah", "penyakit_khusus", "alamat_lengkap", "rt_rw", "dusun_jalan", "desa_kelurahan", "kecamatan", "kota_kabupaten", "provinsi", "kode_pos", "hobi", "cita_cita", "asal_sekolah", "npsn", "alamat_sekolah", "no_ijazah_skhun", "no_peserta_ujian", "tahun_lulus", "yang_membiayai", "kebutuhan_khusus", "kebutuhan_disabilitas", "no_kip", "no_kk", "nama_kepala_keluarga", "no_kks_kps", "nama_ayah", "nik_ayah", "tempat_tanggal_lahir_ayah", "status_ayah", "pendidikan_ayah", "pekerjaan_ayah", "penghasilan_ayah", "no_telp_ayah", "nama_ibu", "nik_ibu", "tempat_tanggal_lahir_ibu", "status_ibu", "pendidikan_ibu", "pekerjaan_ibu", "penghasilan_ibu", "no_telp_ibu", "nama_wali", "nik_wali", "tempat_tanggal_lahir_wali", "status_wali", "pendidikan_wali", "pekerjaan_wali", "penghasilan_wali", "no_telp_wali", "hubungan_wali", "status_santri", "tanggal_nonaktif", "alasan_nonaktif", "foto_santri", "berkas_pendukung", "pindah_ke", "tahun_pindah", "tanggal_boyong"],
